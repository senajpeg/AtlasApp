                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              "${studentName.replaceAll(' ', '_')}_BEP.pdf",
                              style: TextStyle(
                                fontSize: 15.sp,
                                fontWeight: FontWeight.bold,
                              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: () async {
                    ...
                    // PDF'i arka planda oluşturuyoruz
                    final pdfBytes = await BepPdfGenerator.generateBepPdf(
                      bepState,
                    );

                    // Tabletin/Telefonun kendi paylaşma ve kaydetme menüsünü açıyoruz
                    await Printing.layoutPdf(
                      onLayout: (PdfPageFormat format) async => pdfBytes,
                      name:
                          '${studentName.replaceAll(' ', '_')}_BEP_Raporu.pdf',
                    );
                  },
